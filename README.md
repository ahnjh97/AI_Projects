...
### 01. 호흡기 건강 예보 [프로젝트 링크](./1%EC%B0%A8%20Project%28Flask%2C%EB%A8%B8%EC%8B%A0%EB%9F%AC%EB%8B%9D%29/)
...
### 02. PreDect [프로젝트 링크](./2%EC%B0%A8%20Project%28Computer%20Vision%29/)
...
### 03. Unity/GameDev LLM Tutor [프로젝트 링크](./3%EC%B0%A8%20Project%28LLM%20Fine-Tuning%29/)
...
**핵심 기술:** Llama 3.2 3B, QLoRA, Instruction Tuning, Flask-RESTX
...
- **LLM 서비스:** instruction dataset 구성, QLoRA 기반 instruction tuning과 도메인 fine-tuning, 프롬프트와 응답 후처리
