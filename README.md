...
모델 학습에 그치지 않고 **데이터 준비 → 학습과 평가 → 추론 → API → 사용자 화면**으로 이어지는 과정을 구현했습니다. 각 프로젝트 폴더의 README에서 주요 기능, 설계, 구현 포인트와 실행 방법을 확인할 수 있습니다.
...
- 실행 조건은 각 폴더의 README에 정리했습니다. Oracle 데이터, 예측 모델 파일, LLM 가중치와 서빙 환경 등 별도 준비가 필요한 항목을 구분했습니다.
